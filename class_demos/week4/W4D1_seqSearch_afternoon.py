...
while answer == "y":
    ...
    if search_type == "1": #LAST NAME
        ...
        #step 1: set-up and gain search query
        found = []  #empty list, found locations (index) will be stored if found
        search_let= input("Enter the LETTER GRADE you wish to find: ") #grade we are looking for all students for
